...
## Flowcharts  
[flowcharts](./docs/project_flowcharts.md)

## Sequence Diagrams  
There are a few key sequences which are worth examining.  The one that is most interesting is how a object with a task is contructed and spun up.  [sequence diagrams](./docs/project_sequences.md)
